...
#define DSS_DMA_QOS_BASE			(0x45DC2000)
#define CSL_NAVSS0_NBSS_NB0_CFG_MMRS_BASE	(0x3802000)

#define CSL_NAVSS0_NBSS_NB1_CFG_MMRS_BASE	(0x3803000)
#define CSL_DSS0_VIDL1_BASE	(0x4a20000)
#define CSL_DSS0_VIDL2_BASE	(0x4a30000)
#define CSL_DSS0_VID1_BASE	(0x4a50000)
#define CSL_DSS0_VID2_BASE	(0x4a60000)
